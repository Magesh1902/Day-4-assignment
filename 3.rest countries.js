...
const Country = [
    ...
    let cities = countries.forEach((Country) => { console.log("Country Name :",Country.name,",","Region :",Country.region,",","Sub Region :",Country.subregion,",","Population :",Country.population) });
